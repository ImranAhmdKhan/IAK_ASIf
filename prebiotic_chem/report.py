...
class PrebioticReport:
    ...
    def _header(self) -> str:
        lines = [
            _SEP,
            _center("PREBIOTIC CHEMISTRY COMPUTATIONAL REPORT"),
            _center("prebiotic_chem — Professional Computational Chemistry"),
            _SEP,
        ]
        return "\n".join(lines)
    ...
    def _footer(self) -> str:
        return "\n".join([
            _SEP,
            _center("Generated by prebiotic_chem"),
            _center("Inspired by ChemRefine (Sterling Group, UT Dallas)"),
            _SEP,
        ])
