...
This is a single-file version of the previous IAK v11.1 script with the
requested v11.2 additions incorporated directly into the same script:
...
- Interactive molecular model viewer with Chemcraft-like style choices:
  Ball-and-stick, CPK, Wireframe, and Licorice.
- User-selectable atom, bond, background, graph, axis, and grid colors.
- Existing xTB, CREST, ORCA, WSL sandbox, batch-ratio, table, and graph
  workflow behavior retained from the earlier script.
"""
